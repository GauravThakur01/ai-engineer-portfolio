    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            {/* Contact Details */}
            <motion.div variants={itemVariants} className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      href={info.href}
                      whileHover={{ x: 5 }}
                      className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-300 group"
                    >
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className={`flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl text-gray-600 dark:text-gray-400 ${social.color} transition-all duration-300 hover:shadow-lg`}
                    >
            ...
            {/* Availability */}
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-cyan-500/10 to-purple-600/10 rounded-3xl p-8 border border-cyan-500/20">
            ...
            <motion.div variants={itemVariants} className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="flex flex-wrap gap-3">
                {['OpenAI', 'LangChain', 'FastAPI', 'Python', 'React', 'Azure', 'Docker'].map((tech, index) => (
                  <span
                    key={index}
                    className="px-3 py-2 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-full text-sm text-gray-700 dark:text-gray-300"
                  >
                    {tech}
                  </span>
                ))}
        ...
        >
          <motion.div variants={itemVariants} className="text-center bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Email Response</h4>
          ...
          <motion.div variants={itemVariants} className="text-center bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Call Availability</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">9 AM - 9 PM IST</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Project Discussion</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Free consultation</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Remote friendly</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
